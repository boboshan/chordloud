...
export default class PitchClass {
	 ...
	 * @example
	 * ```typescript
	 * PitchClass.from('C#').accidental; // '#'
	 * PitchClass.from('D').accidental; // null
	 * ```
	 */
	 ...
	 * @example
	 * ```typescript
	 * PitchClass.from('C').step; // 0
	 * PitchClass.from('D').step; // 1
	 * ```
	 */
	get step(): number {
	 ...
	 * @example
	 * ```typescript
	 * PitchClass.from('C#').alteration; // 1
	 * PitchClass.from('Db').alteration; // -1
	 * ```
	 */
	 ...
	 * @example
	 * ```typescript
	 * PitchClass.from('C').chroma; // 0
	 * PitchClass.from('C#').chroma; // 1
	 * PitchClass.from('Db').chroma; // 1
	 * ```
	 */
	get chroma(): number {
	...
	/**
	 * Checks if this pitch class is natural (no accidental)
	 */
	get isNatural(): boolean {
		return this.accidental === null || this.accidental === 'n';
	}

	/**
	 * Checks if this pitch class has a sharp accidental
	 */
	get isSharp(): boolean {
		return this.accidental === '#' || this.accidental === 'x';
	}

	/**
	 * Checks if this pitch class has a flat accidental
	 */
	get isFlat(): boolean {
	 ...
	 * @example
	 * ```typescript
	 * const pc = PitchClass.fromName('C#');
	 * ```
	 */
	 ...
	 * @example
	 * ```typescript
	 * PitchClass.fromChroma(1); // C#
	 * PitchClass.fromChroma(1, false); // Db
	 * ```
	 */
	...
	/**
	 * Converts this pitch class to a JSON-serializable object
	 * 
	 * @example
	 * ```typescript
	 * const pc = PitchClass.from('C#');
	 * const json = pc.toJSON();
	 * // { type: 'PitchClass', letter: 'C', accidental: '#' }
	 * ```
	 */
	toJSON(): { type: 'PitchClass'; letter: string; accidental: string | null } {
		return {
			type: 'PitchClass',
			letter: this.letter,
	...
	/**
	 * Creates a PitchClass from a JSON object
	 * 
	 * @example
	 * ```typescript
	 * const json = { type: 'PitchClass', letter: 'C', accidental: '#' };
	 * const pc = PitchClass.fromJSON(json);
	 * ```
	 */
	static fromJSON(json: { letter: string; accidental: string | null }): PitchClass {
		return PitchClass.create(json.letter, json.accidental);
	}
